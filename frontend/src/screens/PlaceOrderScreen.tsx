...
import { useCreateOrderMutation } from '../state/slices/ordersApiSlice';
import { clearCartItems } from '../state/slices/cartSlice';
              ...
              {cart.cartItems.length === 0 ? (
                ...
                <ListGroup variant='flush'>
                  {cart.cartItems.map((item:ICartItem, index) => (
                    <ListGroup.Item key={index} className='m-0 py-3'>
                      <Row>
                        <Col md={1}>
                          <Image
